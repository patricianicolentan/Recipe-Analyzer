...
# Version 5 of the recipe analyzer. Compared to V4, this one prints the top ten ingredient pairs regardless of their scores.
# I also fixed a bug where an ingredient would be listed as pairing with itself.
...
# this prints the top ten ingredient pairs and their scores; this is changeable.
for pair_d in d:
	if k < 10:
		if pair_d != x_ingredient:
